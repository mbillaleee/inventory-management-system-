                    ...
                    <div class="card-body">
                            ...
                            <div class="col-12">
                                <div class="invoice-title">
                                    ...
                                    <h3>
                                        <img src="{{ asset('backend/assets/images/logo-sm.png') }}" alt="logo"
                                            height="24" /> Secret Seven Shopping Mall
                                    </h3>
                                </div>
                                <hr>
                                ...
                                <div class="row">
                                    <div class="col-6 mt-4">
                                        <address>
                                            <strong>Secret Seven Shopping Mall:</strong><br>
                                            Khamarbari Dhaka<br>
                                            mbillal.eee@gmail.com
                                        </address>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div>
                                    <div class="p-2">
                                        <h3 class="font-size-16"><strong>Daily Invoice Report</strong></h3>
